...
<!-- <div class="wrapper">-->
  <div id="building">
   <div style="margin: 100px auto; background-color: rgba(255, 255, 255, 0.5); width: 400px; height: 340px; padding: 20px; border-radius: 10px">
...
/*.wrapper {*/
/*  height: 100vh;*/
/*  background-image: linear-gradient(to bottom right, #0f5efa, #6beeb0);*/
/*  overflow: hidden;*/
/*}*/
#building {
  background:url("../assets/sean-pollock-PhYq704ffdA-unsplash.jpg");
  width:100%;
  height:100%;
  position:fixed;
